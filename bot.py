...
if salon_logs and role_ping:
    await salon_logs.send(f"{role_ping.mention} 📜 **{ctx.author.display_name}** a invoqué la magie *Atomic* sur {membre.mention}.\n"f"Il faut lui supprimer son inventaire au plus vite et screen ce qu'il a dedans !")
else:
